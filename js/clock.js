...
let log_area = document.getElementById("calc-log");
let bgClock = document.getElementById("clock-background-image");
let bgMonitor = document.getElementById("monitor-background-image");
...
let posMinute;
let posHour;
let intervalSecond = getRadian(6) / updateSecond;
let intervalMinute = getRadian(6) / updateMinute;
let intervalHour = getRadian(30) / updateHour;
